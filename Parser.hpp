...
{
private:
    inline static constexpr std::size_t MAX_PARAMS_COUNT = 2;
    inline static constexpr std::size_t NPOS = SIZE_MAX;

    struct AST;
    union Data;
    enum class Tag : uint8_t;
    inline static std::list<std::unique_ptr<Parser::AST>> arena;
